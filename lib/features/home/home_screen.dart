    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Container(decoration: BoxDecoration(gradient: advancedCoffeeGradient3,),
            child: Padding(
                          ...
                          onTap: () {
                            debugPrint(
                              "Navigating to details for: ${coffee.name}",
                                ...
                                Navigator.pushNamed( context,AppRoutes.beanDetails,arguments: coffee,);
                          },
                  ...
                  SizedBox(
                    ...
                    child: ListView.builder(
                      itemBuilder: (BuildContext context, int index) {
                        ...
                        return InkWell(
                          onTap: () {
                            Navigator.pushNamed( context,AppRoutes.coffeeDetails,arguments: cappuccino,);
                          },
                          child: Padding(
                            padding: const EdgeInsets.only(left: 10, right: 5),
                            child: Container(
