...
class BeanDetailsScreen extends StatefulWidget {
  ...
  const BeanDetailsScreen({super.key, required this.coffeeBean});
...
class _BeanDetailsScreenState extends State<BeanDetailsScreen> {
  ...
  void initState() {
    ...
    _selectedSize = widget.coffeeBean.defaultSize;
  }

  @override
  Widget build(BuildContext context) {

    final double currentPrice = widget.coffeeBean.sizesAndPrices[_selectedSize] ?? widget.coffeeBean.defaultPrice;
                      ...
                      children: [
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                SizedBox(width: 4.w),
                                Text(
                                  widget.coffeeBean.rating.toString(),
                        ...
                        Column(
                          ...
                          children: [
                            Row(
                              children: [
                                _buildBadgeIcon(Icons.energy_savings_leaf, "Bean"),
                                SizedBox(width: 10.w),
                                _buildBadgeIcon(Icons.location_on, "Africa"),
                              ],
                            ),
                            SizedBox(height: 12.h),
                            Container(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: widget.coffeeBean.sizesAndPrices.keys.map((size) {
